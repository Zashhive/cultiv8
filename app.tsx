...
// Type definitions
interface CourseOffering {faqData.map((faq, index) => (
              <div key={index          </div>
        </div>
      </section>
...
// Render the app
ReactDOM.render(<App />, document.getElementById('root')); className="bg-white rounded-lg shadow-md overflow-hidden">
                <button 
